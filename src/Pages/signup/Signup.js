    ...
    return (
        <div className="relative">
            ...
            <div className="relative  z-10">
                ...
                <div className="container flex flex-wrap-reverse items-center justify-center  px-6 mx-auto py-10">
                   ...
                   
                    {
                        ...
                        <div className={`max-w-sm p-3.5 bg-white mt-[10%] `}>
                            ...
                            <button className='px-6 py-3.5 bg-rose-700 text-white rounded-md mt-4 ml-auto block '>Agree</button>
                    </div>
                        </>
                    }
...
// export const CodeOfConduct = ({ visible }) => {
