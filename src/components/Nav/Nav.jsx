    ...
    return (
        <>
            <div className="h-[240px] relative object-cover bg-center bg-no-repeat py-4">
                <img
                    src="https://cdn.pixabay.com/photo/2019/04/28/15/13/pen-4163403_960_720.jpg"
                    className="absolute inset-0 object-cover w-full h-full"
                    alt=""
                />
            </div>
            <div class="px-4 py-5 mx-auto  md:max-w-full lg:max-w-screen-full md:px-24 lg:px-8 bg-rose-600 text-white">
                <div class="relative flex items-center justify-between">
                    ...
                    <ul class="flex items-center hidden space-x-8 lg:flex">
                        ...
                        <select id="lang" class="bg-gray-50 border border-gray-300 text-slate-800 text-sm rounded-lg ">
                                ...
                                <div class="p-5 bg-white border rounded shadow-sm">
                                    <div class="flex items-center justify-between mb-4">
                                        ...
                                        <div>
                                            ...
                                            >
                                                <svg class="w-5 text-slate-800" viewBox="0 0 24 24">
                                                    <path
                                                        fill="currentColor"
